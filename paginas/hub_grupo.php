...
<head>
 ...
 $(".close").click(function(){
    ...
    function ajax(){
        ...
        req.open('GET','conversag.php', true);
        req.send();
...
?>
    ...
    <div class="enviar w3-container">
                ...
                <?php
                    echo "<form action='hub_grupo.php?id_info=$info_resu&id=$id_para&nome=$nome' name='formulario1' method='post'>";
                ?>
                <div class="texto">
...
$sql="INSERT INTO `tb_grupo_msn`( `cd_grupo`, `ds_msn_grupo`, `cd_de_grupo`, `hr_hora`, `dt_hora`, `nm_qenviou`) VALUES ('$id_para','$msn','$id_de','$hora','$data','$info_nome' )";
mysqli_query($con,$sql)or die ("Erro ao tentar insirir menssagem");
echo"<script> window.location.href='hub_grupo.php?id_info=$info_resu&id=$id_para&nome=$nome'</script>";
}
